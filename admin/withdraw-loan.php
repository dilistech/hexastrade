...
use PHPMailer\PHPMailer\Exception;
 ...
 if (isset($_POST['approve'])) {
    ...
    $body .= '<p>Amount:'.$amount.'</p>';
        $body .= '<p>To invest your loan, kindly create an investment plan of your choice
        and activate it.</p>';       
        $body .= '<p><a href="https://hexastrade.com">Hexas Trade</a></p>';
        $body .= '</div>';

        

        send_email($row -> email,'Loan Withdrawal successful',$row -> first_name, $row -> last_name,$body,new PHPMailer(true));
