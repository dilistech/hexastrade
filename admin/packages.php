...
if (!isset($_SESSION['admin_id'])) {
 ...
 if (isset($_POST['submit'])) {
       ...
       withdraw_duration = :withdraw_duration,min = :min_amount,max = :max_amount
        Where id = :id LIMIT 1';
...
swal("Good job!", "Changes saved successfully!", "success");
 ...
 <div class="container">
     ...
     <h3 style="margin:20px 0"> INVESTMENT PLANS</h3>
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="number" name="min_amount" class="form-control"
                                                 placeholder="Min Amount" value="<?php echo $row -> min?>" step="any"
                                                 required>
                                         </div>
                                     </div>
                                     <div class="form-group row">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="number" name="max_amount" class="form-control"
                                                 placeholder="Max Amount" value="<?php echo $row -> max?>" step="any"
                                                 required>
                                         </div>
                                     </div>
                                 </div>
