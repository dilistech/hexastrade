...
$amount = 0.00;
  ...
  $sql_a = 'SELECT *,account.tid AS aid  FROM `account` INNER JOIN packages ON account.package_id = packages.id WHERE 
   account.user_id = :user_id && account.status = 1 && account.balance > 0';
...
?>
 <?php
$title = 'Hexastrade - Dashboard - Withdraw';
...
?>
 ...
 <div class="container">
     ...
     <div class="table-responsive" style="overflow-x: auto">
         <table class="table table-dark table-bordered table-sm" style="width:auto">
             <thead>
                 <tr>
                     <th>#</th>
                     <th>Plan</th>
